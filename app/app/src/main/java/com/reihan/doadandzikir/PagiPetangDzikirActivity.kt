...
class PagiPetangDzikirActivity : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Untuk Button dan Cardview Dzikir Pagi
        ...
        //Untuk Button dan Cardview Dzikir Petang
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            //Menjalankan Acitivity Dzikir Pagi Jika User memilih Dzikir Pagi
            ...
            //Menjalankan Acitivity Dzikir Petang Jika User memilih Dzikir Petang

...
import com.reihan.doadandzikir.adapter.ArtikelAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupViewPager(){
        val llSliDots: LinearLayout = findViewById(R.id.ll_slider_dots)
        ...
        for(i in 0 until listArtikel.size){
            ...
            // Menerapkan param sebagai aturan bagaimana indicator di tampilkan
            llSliDots.addView(dotSlider[i], params)
        }
    ...
    private fun initView(){
        ...
        val llDzikirDoaDanHarian: LinearLayout = findViewById(R.id.ll_dzikir_doa_harian)
        llDzikirDoaDanHarian.setOnClickListener{
